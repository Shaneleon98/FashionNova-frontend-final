...
const[filteredProducts, setFilteredProduts] = useState(ProductsData);
...
return (
    ...
    <div className='w-full mb-12 flex flex-col md:flex-row items-center justify-center gap-4'>
       <input type="text" 
        ...
        <button onClick={handleSearch}  className='search-btn w-full md:w-auto py-2 px-8 bg-colors-primary text-white rounded'>Search</button>
    </div>
