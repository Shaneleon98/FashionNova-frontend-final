    ...
    <div className='container max-auto p-6'>
        <div className='bg-white shadow-md rounded-lg p-6'>
           <div className='flex items-center mb-4'>
               <img src={formData.profileImage || avatarImage} alt="" className='w-32 h-h2 object-cover rounded-full' />
               <div className='ml-6'>
                  <h3 className='text-2x1 font-semibold'>Username: {formData?.username || 'N/A'}</h3>
               ...
               <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 3H4a1 1
                0 00-1 1v14a1 1 0 001 1h7m2 0h7a1 1 0 001-1V4a1 1 0 00-1-1h-7m-2 0v14"></path>
                </svg>
               </button>
           </div>
        </div>
        ...
        {/* show modal  */}
        {
            isModalOpen && (
                <div className='fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center'>
                    <div className='bg-white p-6 rounded-lg md:w-96 max-w-xl max-auto relative'>
                         <button 
                          onClick={()=> setIsModalOpen(false)}
                          className='absolute top-2 right-2 text-gray-100 hover:text-gray-700'><i className='ri-close-line size-8 p-2 bg-black rounded-full'></i></button>
                           <h2 className='font-2xl font-bold mb-4'>Edit Profile</h2>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className='mb-4'>
                                   ...
                                   <textarea name="bio" row="3" className='mt-1 p-2 w-full border border-gray-300 rounded-md shadow-sm' value={formData?.bio}
