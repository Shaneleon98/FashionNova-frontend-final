       ...
       <div className='flex items-center mb-4'>
        {
            [1, 2, 3, 4, 5].map((star) => (
                ...
                className='curser-pointer text-yellow-500 text-xl'>
                    {
        ...
        <div className='flex justify-end gap-2'>
           <button 
            onClick={handleClose}   className='px-4 py-2 bg-grey-300 rounded-md'>Cancel</button>
            <button
            onClick={handleSubmit}
            className='px-4 py-2 bg-colors-primary-dark text-white rounded-md'>Submit</button>
         </div>
    </div>
    </div> 
  )
